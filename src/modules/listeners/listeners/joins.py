...
async def on_member_join(member):
    embed = Embed(title="Electro Cafe™", description=f"Welcome to our server, {member.mention}!", color=embedColor.DEFAULT.value)
    ...
    embed.description="Post an introduction: <#1464636617716269330>\nCome chat with us: <#1480599558642728990>\n"
    ...
    channel = member.guild.get_channel(1480599558642728990)
    await channel.send(member.mention, embed=embed)
